...
def add_P9(sim):
    sim.add(a = 700, e = .6, m = 3.0033e-5, omega =150.0/180*np.pi, inc = 30.0/180*np.pi)
...
#save data points more often to zoom in later with load states
times = []
energies = []
...
sim.ri_ias15.epsilon = 1e-12   # accuracy parameter
sim.ri_ias15.min_dt = 0       # optional lower bound
...
# a = data["a"]['time index']['particle index']
# simulate_and_save(sim,int_time_step,int_total_time,int_archive_interval)